            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.headerContainer}>
                    <Image
                        ...
                        resizeMode="contain"
                    />
                    <Text style={[styles.title, { color: theme.text }]}>Join Partner Fleet</Text>
                    <Text style={[styles.subtitle, { color: theme.tabIconDefault }]}>Earn more with every mile.</Text>
                </View>
                ...
                <View style={styles.formContainer}>
                    ...
                    <TouchableOpacity
                        style={[styles.button, { backgroundColor: '#9d50bb', opacity: loading ? 0.7 : 1 }]} // Purple branding
                    ...
                    <View style={styles.loginRow}>
                        <Text style={{ color: theme.tabIconDefault }}>Already have a partner account? </Text>
                        <TouchableOpacity onPress={() => router.push('/login')}>
                            <Text style={[styles.loginText, { color: '#9d50bb' }]}>Log In</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </ScrollView>
