    ...
    >
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          <Text style={[typography.h1, { color: colors.secondary, marginBottom: spacing.md }]}>
            VehicAid
          </Text>
          <Text style={[typography.subtitle, { color: colors.gray[600], textAlign: 'center' }]}>
        ...
        <Card style={styles.card}>
          <Text style={[typography.h2, { marginBottom: spacing.lg }]}>Provider Login</Text>
